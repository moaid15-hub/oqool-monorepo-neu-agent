...
export class IncrementalAnalyzer {
     ...
     */
    async analyzeIncremental(files) {
     ...
     * عرض التغييرات
     */
    displayChanges(changed, added, removed, unchanged) {
...
// تصدير instance
export function createIncrementalAnalyzer(workingDir) {
