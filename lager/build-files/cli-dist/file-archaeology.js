...
export class FileArchaeology {
    ...
    async traceFile(filePath) {
        ...
        try {
            ...
            // ترتيب حسب التاريخ
            fileSnapshots.sort((a, b) => new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime());
     ...
     */
    async displayFileHistory(filePath) {
     ...
     */
    async compareWithSnapshot(filePath, snapshotId) {
     ...
     */
    async findMostChangedFiles(limit = 10) {
...
export function createFileArchaeology(workingDir) {
    return new FileArchaeology(workingDir);
}
//# sourceMappingURL=file-archaeology.js.map