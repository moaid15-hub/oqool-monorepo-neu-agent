...
export class SEOSpecialistAgent {
    ...
    // ============================================
    async generatePageMetadata(page, spec) {
        const prompt = `
...
\`\`\`
    ...
    // ============================================
    async generateStructuredData(spec) {
...
Crawl-delay: 1
    ...
    // ============================================
    async createContentStrategy(spec) {
        return [
...
//# sourceMappingURL=seo-specialist-agent.js.map