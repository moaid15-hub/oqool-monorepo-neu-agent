...
// ============================================
import { ArabicAgent } from './arabic-agent.js';
// ============================================
// 🔧 إعداد الوكيل العربي
...
async function example12_CompleteProjectWorkflow() {
    ...
    try {
        ...
        const backendCode = await agent.ideaToCode('اكتب Express API لإدارة المهام (CRUD)', 'javascript', 'medium');
        console.log('✅ تم توليد Backend\n');
        // 3. توليد كود Frontend
        console.log('🎨 المرحلة 3: توليد Frontend\n');
        const frontendCode = await agent.ideaToCode('اكتب React component لعرض وإدارة قائمة المهام', 'javascript', 'medium');
...
// Export للاستخدام
export { example1_SimpleSetup, example2_MultiProviderSetup, example3_UnderstandRequirement, example4_IdeaToCode, example5_ExplainCode, example6_ExplainError, example7_GenerateExample, example8_ExtractIntent, example9_TranslateTerms, example10_InteractiveChat, example11_DisplayStatistics, example12_CompleteProjectWorkflow, example13_CostComparison, example14_CachingExample, runAllExamples };
// تشغيل تلقائي إذا تم استدعاء الملف مباشرة
if (import.meta.url === `file://${process.argv[1]}`) {
    runAllExamples().catch(console.error);
}
//# sourceMappingURL=arabic-agent-examples.js.map