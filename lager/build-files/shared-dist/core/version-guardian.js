...
export class VersionGuardian {
    ...
    // ============================================
    async diff(snapshot1Id, snapshot2Id) {
    ...
    async showDiff(snapshot1Id, snapshot2Id) {
    ...
    async restoreBackup(backupName) {
        ...
        const snapshot = JSON.parse(await fs.readFile(backupPath, 'utf-8'));
    ...
    async createGitCommit(message, description) {
    ...
    async createGitTag(tag, message) {
        const cwd = this.config.projectPath;
    ...
    async showFileArchaeology(filePath) {
    ...
    async getAnalytics() {
        ...
        const sizeGrowth = snapshots.map(s => ({
    ...
    // ============================================
    async resolveConflicts(file, conflicts) {
...
`;
    ...
    async importSnapshot(importPath) {
...
// 🏭 Factory Function
// ============================================
export function createVersionGuardian(config) {
    return new VersionGuardian(config);
}
//# sourceMappingURL=version-guardian.js.map