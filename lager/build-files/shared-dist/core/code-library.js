...
export class CodeLibrary {
    ...
    // 💾 حفظ Snippet
    // ============================================
    async saveSnippet(name, code, tags, description) {
        try {
    ...
    async listAllSnippets() {
        try {
            ...
            snippets.forEach((s, i) => {
                console.log(chalk.blue(`${i + 1}. ${s.name}`) +
...
// 🏭 Factory Function
// ============================================
export function createCodeLibrary(config) {
    return new CodeLibrary(config);
}
//# sourceMappingURL=code-library.js.map