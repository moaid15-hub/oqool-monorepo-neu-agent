...
export class CodeReviewer {
    client;
    workingDirectory;
    constructor(apiKey, workingDirectory) {
    ...
    async review() {
        ...
        result.overallScore = Math.round((result.security.score +
